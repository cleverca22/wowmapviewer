 ...
 *
 *  $Id: common.cpp 20 2009-09-07 08:01:26Z statue $
 */
...
int libmpq_file_read_block(mpq_archive *mpq_a, mpq_file *mpq_f, unsigned int blockpos, char *buffer, unsigned int blockbytes) {
	...
	for (i = 0; i < nblocks; i++, index++) {
		...
		// TODO: Fix this line. Generates an error when trying to read MP3 files (which can't be compressed as they already are).
